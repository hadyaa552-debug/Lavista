...
export default function MobileBottomBar() {
  ...
  const whatsappMessage = encodeURIComponent("مرحباً، أنا مهتم بمشاريع لا فيستا للتطوير العقاري. أود الحصول على المزيد من المعلومات.")
    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-background border-t border-border shadow-lg">
      <div className="grid grid-cols-2 gap-0">
        ...
        <button onClick={handleWA}
          className="flex items-center justify-center gap-2 py-4 bg-green-500 text-white font-semibold text-sm hover:bg-green-600 transition-colors cursor-pointer">
