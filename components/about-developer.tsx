...
export default function AboutDeveloper() {
  const stats = [
    { icon: Building2, number: "30+", label: "مشروع متكامل" },
    { icon: MapPin, number: "6", label: "وجهات في مصر" },
    { icon: Users, number: "+50,000", label: "عميل راضٍ" },
    { icon: Award, number: "30+", label: "سنة خبرة" },
  ]
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            شركة لا فيستا للتطوير العقاري من أبرز شركات التطوير في مصر، بخبرة تمتد لأكثر من ثلاثة عقود. تقدم مشروعات سكنية وساحلية متكاملة في ٦ وجهات رئيسية: القاهرة الجديدة، العاصمة الإدارية، الشيخ زايد، الشروق، العين السخنة، والساحل الشمالي.
          </p>
        </div>
