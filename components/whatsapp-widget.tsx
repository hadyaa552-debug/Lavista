...
export default function WhatsAppWidget() {
  ...
  const message = encodeURIComponent("مرحباً، أنا مهتم بمشاريع لا فيستا للتطوير العقاري. أود الحصول على المزيد من المعلومات.")

  const handleClick = () => {
    const url = `${WEBHOOK_URL}?phone=غير+محدد&page=${PAGE_ID}&project=general-float`
