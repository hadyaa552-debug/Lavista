...
export default function ProjectJade() {
  ...
  const whatsappMessage = encodeURIComponent(`مرحباً، أنا مهتم بمشروع ${projectName} في العاصمة الإدارية وأريد معرفة المزيد من التفاصيل`)
    ...
    <section id="jade" className="py-12 lg:py-16 bg-muted/20">
      <div className="w-full px-4 lg:px-8 max-w-screen-xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-6">
          <div className="text-right space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 text-center">
              {[
                { value: "100", label: "فدان" },
                { value: "14%", label: "نسبة مباني" },
                { value: "10", label: "أفدنة كلوب هاوس" },
              ].map((s, i) => (
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-10">
          {["كلوب هاوس ١٠ أفدنة", "مسطحات مائية مميزة", "لاندسكيب واسع", "فود كورت ومطاعم", "ملاعب رياضية", "مناطق أطفال", "جيم خارجي", "أمن ٢٤/٧"].map((f, i) => (
